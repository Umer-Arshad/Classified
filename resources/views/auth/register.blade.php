                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('register.perform') }}">
                                ...
                                <div class="flex flex-col mb-3">
                                    <input type="text" name="firstname" class="form-control" placeholder="Firstname" aria-label="Name" value="{{ old('firstname') }}" >
                                    @error('firstname') <p class='text-danger text-xs pt-1'> {{ $message }} </p> @enderror
                                </div>
                                <div class="flex flex-col mb-3">
                                    <input type="text" name="lastname" class="form-control" placeholder="Lastname" aria-label="Name" value="{{ old('lastname') }}" >
...
-webkit-appearance: none; -moz-appearance: none ; appearance: none">
                                ...
                                <div class="flex flex-col mb-3 ">
                                    ...
                                    <input type="tel" name="phone_no" class="form-control countrycode"  placeholder="phone_no " aria-label="Phone No">
                                    @error('phone_no ') <p class='text-danger text-xs pt-1'> {{ $message }} </p> @enderror
                                </div>
                                <div class="flex flex-col mb-3">
                                    <select    class="form-control" name="user_role_id" style="
                  display: block; width: 100%; padding: .375rem 2.25rem .375rem .75rem; font-size: 1rem;
       font-weight: 400; line-height: 1.5rem; color: #212529; background-color: #fff; background-repeat: no-repeat;
background-position: right .75rem center; background-size: 16px 12px; border: 1px solid #ced4da ; border-radius: .25rem;
-webkit-appearance: none; -moz-appearance: none ; appearance: none" aria-label="User Role">
                                        @if(count($user_role))
                                            ...
                                            @endforeach
                                        @else
                                            <option disabled selected value>No Role Added</option>
                                        @endif
...
@endsection
    ...
    <script>
        ...
        window.intlTelInput(input, {
            ...
            utilsScript: "{{asset('assets/countrycodefiles/js/utils.js')}}",
        });
    </script>
